...
export default function CategoryError({
  ...
  useEffect(() => {
    console.error('Category page error caught by boundary:', error);
  }, [error]);
    ...
    <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 text-center space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground max-w-md mx-auto leading-relaxed">
          We encountered an issue retrieving products for this category. Please try again or browse our full catalog.
        </p>
      </div>
