...
export default function ArticleError({
  ...
  useEffect(() => {
    console.error('Blog article detail error:', error);
  }, [error]);

  return (
    <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 text-center space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground max-w-md mx-auto leading-relaxed">
          We encountered an issue retrieving this article. Please try refreshing or return to the journal.
        </p>
      </div>
