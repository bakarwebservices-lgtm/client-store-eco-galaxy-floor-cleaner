        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-base font-bold leading-tight">
              Edit Coupon: <span className="font-mono text-primary font-bold">{coupon?.code || '...'}</span>
            </h1>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        {loading ? (
          ...
          <div className="rounded-2xl border border-destructive/30 bg-destructive/10 p-8 text-center space-y-3">
            ...
            <h2 className="text-sm font-bold text-destructive">Unable to load coupon</h2>
            <p className="text-xs text-destructive/80">{error || 'Coupon record does not exist.'}</p>
            <Link
              href="/admin/coupons"
