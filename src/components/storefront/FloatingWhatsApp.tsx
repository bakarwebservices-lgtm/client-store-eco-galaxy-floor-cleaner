...
export function FloatingWhatsApp({
  phone = '0346 4815775',
  defaultMessage = 'Hi Eco Galaxy, I would like to inquire about ordering Eco Galaxy Floor Cleaner.',
}: FloatingWhatsAppProps) {
  const cleanPhone = phone.replace(/[^0-9]/g, '');
  // Format for international link: 0346 -> 92346
  ...
  const waUrl = `https://wa.me/${intlPhone}?text=${encodeURIComponent(defaultMessage)}`;
  ...
  return (
    ...
    >
      ...
      <span className="hidden font-heading text-sm font-semibold tracking-wide sm:inline">
        WhatsApp Order &amp; Help
      </span>
    </a>
  );
